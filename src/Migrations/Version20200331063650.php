 ...
 */
final class Version20200331063650 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD preference_id INT DEFAULT NULL, ADD avatar VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP preference_id, DROP avatar');
    }
}
